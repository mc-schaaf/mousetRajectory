...
test_that("MAD: ideal line parameters", {
  ...
  expect_equal(max_ad(x, y, x_start=-1, y_start=-1, x_end=0, y_end=0), max_ad(x,y))
  expect_equal(max_ad(x, y, x_start=1,  y_start=1,  x_end=2, y_end=2), max_ad(x,y))

  # shift up/down
  expect_equal(max_ad(x, y, x_start=0, y_start=-1, x_end=1, y_end=0), sqrt(2))
  expect_equal(max_ad(x, y, x_start=0, y_start=1,  x_end=1, y_end=2), -max_ad(x,y))
