...
test_that("change some parameters", {
  expect_equal(
    time_circle_entered(-5:5, rep(0, 11), -5:5, xMid = 3, radius = 5),
    -2
  )
  expect_equal(
    time_circle_entered(-5:5, rep(0, 11), -5:5,
  ...
  expect_equal(
    time_circle_entered(0:10, rep(0, 11), 0:10, xMid = 10, yMid = 0, radius = 9),
    1
  )
  expect_equal(
    time_circle_entered(0:10, rep(0, 11), 0:10,
      xMid = 10, yMid = 0, radius = 9,
      include_radius = FALSE
    ),
    2
  )
